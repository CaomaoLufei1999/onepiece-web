...
import { Button, Card, Col, Form, List, Row, Select, Tag, Skeleton, Divider } from 'antd';
...
const SearchPosts = () => {
  ...
  const loadMoreData = () => {
    ...
    setLoading(true);
    fetch(`http://localhost:3000/Posts_list?id_gte=${count * 10}&id_lte=${(count + 1) * 10 - 1}`)
      .then((res) => res.json())
      .then((body) => {
        setData([...data, ...body]);
        setLoading(false);
          ...
          >
            <FormItem name="category">
              <TagSelect expandable>
                <TagSelect.Option value="cat1">动态专区</TagSelect.Option>
                <TagSelect.Option value="cat2">话题专区</TagSelect.Option>
                <TagSelect.Option value="cat3">建议专区</TagSelect.Option>
              </TagSelect>
            </FormItem>
          </StandardFormRow>
