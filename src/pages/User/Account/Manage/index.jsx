...
import {
  ...
  Row,
  Col,
  Avatar, Comment, Form, Input, Alert
} from "antd";
...
import {
  ...
  EyeOutlined,
  FieldNumberOutlined,
  HighlightOutlined, HourglassOutlined,
  LikeOutlined,
  LineChartOutlined,
  MessageOutlined,
...
const dashangColumns = [
  {
    ...
    dataIndex: 'name',
    key: 'name',
    render: text => <a><Avatar
      src={"https://gw.alipayobjects.com/zos/antfincdn/XAosXuNZyF/BiazfanxmamNRoxxVxka.png"}></Avatar> {text}</a>,
  },
  {
    title: '打赏文章',
    dataIndex: 'article',
...
const ContentManage = () => {
    ...
    },
    {
      ...
      render: (text, record, _, action) => [
        <a key="editable" onClick={() => {
          var _a;
          (_a = action === null || action === void 0 ?
            void 0 : action.startEditable) === null || _a === void 0 ? void 0 :
  ...
  const menu = (<Menu>
    <Menu.Item key="1" onClick={showLargeDrawer}>查看数据</Menu.Item>
    ...
    >
      <ProCard hoverable bordered>
        <Tabs defaultActiveKey="1" onChange={callback} tabPosition={"left"} style={{height: 800}}>
          <TabPane tab={<span><DatabaseOutlined/>文章管理</span>} key="1">
            <ProTable columns={columns} actionRef={actionRef} cardBordered
            ...
            }} dateFormatter="string" headerTitle="文章列表" toolBarRender={() => [
              <Button key="button" icon={<PlusOutlined/>} type="primary">
                发布新文章
              </Button>,
            ]}/>
          </TabPane>
          <TabPane tab={<span><BarChartOutlined/>作品数据</span>} key="4">
            博客数据统计
            <Row style={{marginTop: 15}}>
              <Col span={24} lg={24} md={24}>
                <StatisticCard.Group title="" direction={responsive ? 'column' : 'row'}>
                  <StatisticCard bordered={true}
                                 statistic={{
                                   title: <span><EyeOutlined/> 总阅读量</span>,
                                   tip: '访问总数',
                                   value: 799,
                                   // precision: 2,
                                 }}
                  ...
                  <StatisticCard bordered={true}
                                 statistic={{
                                   title: <span><MessageOutlined/> 总评论量</span>,
                                   tip: '评论总数',
                                   value: 15,
                                   // precision: 2,
                                 }}
                  ...
                  <StatisticCard bordered={true}
                                 statistic={{
                                   title: <span><LikeOutlined/> 总点赞量</span>,
                                   tip: '点赞总数',
                                   value: 19,
                                   // precision: 2,
                                 }}
                  ...
                  <StatisticCard bordered={true}
                                 statistic={{
                                   title: <span><StarOutlined/> 总收藏量</span>,
                                   tip: '收藏总数',
                                   value: 29,
                                   // precision: 2,
                                 }}
            ...
            <Row style={{marginTop: 15}}>
              <Col span={24} lg={24} md={24}>
                <StatisticCard.Group title="" direction={responsive ? 'column' : 'row'}>
                  <StatisticCard bordered={true}
                                 statistic={{
                                   title: <span><HourglassOutlined/> 解题数量</span>,
                                   tip: '解题数量',
                                   value: 799,
                                   // precision: 2,
                                 }}
                  ...
                  <StatisticCard bordered={true}
                                 statistic={{
                                   title: <span><FieldNumberOutlined/> 积分排名</span>,
                                   tip: '积分排名',
                                   value: 15,
                                   // precision: 2,
                                 }}
                  ...
                  <StatisticCard bordered={true}
                                 statistic={{
                                   title: <span><UsergroupAddOutlined/> 粉丝数量</span>,
                                   tip: '粉丝数量',
                                   value: 19,
                                   // precision: 2,
                                 }}
                  ...
                  <StatisticCard bordered={true}
                                 statistic={{
                                   title: <span><HighlightOutlined/> 文章总数</span>,
                                   tip: '文章总数',
                                   value: 29,
                                   // precision: 2,
                                 }}
          ...
          <TabPane tab={<span><RedEnvelopeOutlined/>博文打赏</span>} key="5">
            博文打赏信息
            <Table columns={dashangColumns} dataSource={dashangData} style={{marginTop: 15}}></Table>
          </TabPane>
          <TabPane tab={<span><LineChartOutlined/>粉丝数据</span>} key="6">
            ...
            }} search={{}} rowKey="name" headerTitle="粉丝列表"
                     request={async (params = {}) => request('https://proapi.azurewebsites.net/github/issues', {
                       params,
                     })} pagination={{
              pageSize: 10,
          ...
          <TabPane tab={<span><ApartmentOutlined/>粉丝服务</span>} key="7">
            粉丝服务
            <Comment
            ...
            />
            <Alert
              message={<span><QuestionCircleOutlined /> 群发功能提示</span>}
              description="为防止社区恶意消息群发，每人每周只能群发一次消息，且有字数限制，请珍惜群发次数！"
              type="warning"
              style={{marginTop:15}}
            />
          </TabPane>
          <TabPane tab={<span><TagsOutlined/>兴趣标签管理</span>} key="2">
            兴趣标签管理 TODO
          </TabPane>
          <TabPane tab={<span><TeamOutlined/>友情链接管理</span>} key="3">
            友情链接管理 TODO
          </TabPane>
        </Tabs>
      </ProCard>
      ...
      >
        ...
        <StatisticCard.Group title="" direction={responsive ? 'column' : 'row'}>
          <StatisticCard bordered={true}
                         statistic={{
                           title: <span><EyeOutlined/> 阅读量</span>,
                           tip: '访问总数',
                           value: 799,
                           // precision: 2,
                         }}
          ...
          <StatisticCard bordered={true}
                         statistic={{
                           title: <span><MessageOutlined/> 评论量</span>,
                           tip: '评论总数',
                           value: 15,
                           // precision: 2,
                         }}
          ...
          <StatisticCard bordered={true}
                         statistic={{
                           title: <span><LikeOutlined/> 点赞量</span>,
                           tip: '点赞总数',
                           value: 19,
                           // precision: 2,
                         }}
          ...
          <StatisticCard bordered={true}
                         statistic={{
                           title: <span><StarOutlined/> 收藏量</span>,
                           tip: '收藏总数',
                           value: 29,
                           // precision: 2,
                         }}
        ...
        <Table columns={tableColumns} dataSource={tableData} onChange={onTableChange} pagination={{
          current: 1,
          pageSize: 5,
        }}/>
      </Drawer>
