import {Button, Card, Col, Drawer, Form, Input, Row, Select, Space, Tag} from "antd";
import {
  CaretRightOutlined,
  CoffeeOutlined,
  FieldTimeOutlined,
...
const AlgorithmStudy = () => {
  ...
  const [codeData, setCodeData] = useState('public class Test {\n' +
    '  /**\n' +
    '   * 姓名\n' +
    '   */\n' +
    '  private String name;\n' +
  ...
  return (
    <PageContainer
      ...
      footer={[
        ...
        <Button type={"primary"} key={"222"} onClick={showDrawer}>提 交</Button>,
      ]}
    >
      <GridContent>
        <Row gutter={24}>
                    ...
                    <Row>
                      ...
                      <Col span={4}>
                        ...
                        <Select bordered={false} key={1111} defaultValue="Java" style={{width: 120}}
                                onChange={handleSelectChange}>
                          <Option key={11} value="Java">Java</Option>
